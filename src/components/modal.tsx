        ...
        <div className="modal max-w-md mx-auto xl:max-w-5xl lg:max-w-5xl md:max-w-2xl bg-white max-h-screen shadow-lg flex-row rounded relative">
          ...
          <div className="modal-body p-5 w-full h-full overflow-y-auto ">
            <p className="text-justify">
              ...
              voluptates eveniet labore dolorum molestiae, modi saepe fugiat
              minima repudiandae repellendus obcaecati voluptatibus ab tenetur
              recusandae eius quos at maiores atque consectetur facilis! Nisi
              fuga
            </p>
          </div>
          <div className="modal-footer py-3 px-5 border0-t text-right">
            <button className="bg-green-500 px-5 py-2 text-white">OK</button>
          </div>
        </div>
    </main>
  );
